  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Campaign List</h1>
          <p className="text-gray-600 mt-1">View all campaigns in the system</p>
        </div>
