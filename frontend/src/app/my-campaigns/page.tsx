...
export default function MyCampaigns() {
  ...
  const fetchMyCampaigns = async () => {
    try {
      setLoading(true);
      setError(null);
      // Using all campaigns for "my campaigns" - you can modify this logic
      // to filter by user_id once authentication is integrated
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">My Campaign List</h1>
          <p className="text-gray-600 mt-2">Manage your assigned campaigns</p>
        </div>
        <button 
      ...
      {!loading && !error && campaigns.length === 0 && (
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-sm border-2 border-blue-100 p-16 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">No campaigns assigned</h3>
            <p className="text-gray-600 mb-8 text-lg">You don't have any campaigns assigned to you yet</p>
            <button 
              onClick={() => setShowCreateModal(true)}
